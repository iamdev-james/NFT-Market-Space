  ...
  return (
    <main>
      ...
      <div className="bg-white pt-12 pb-5 px-6 rounded-xl text-center leading-loose shadow-2xl">
        <img src={userObj.userInfo.picture} alt={userObj.userInfo.given_name} className="m-auto w-16 h-16 rounded-full" />
        <p className="text-xl font-bold py-3">{userObj.userInfo.name}</p>
