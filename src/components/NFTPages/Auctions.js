...
const Item = (Item) => {
  return (
    ...
    <img src={Item.asset?.image_url || 'https://lh3.googleusercontent.com/0oIfvpJPgWG9vCb_obS0pDmtrzoCuL3f5_tczGjU4s1J88UfU9F2D_fa22T-Z3-WoCKGgIV48wt3QQ7dXrAhR3P1Pw5x78aEpAopEQ'} alt={Item.asset?.name || 'N/A'} style={{
      width: '100%',
      height: '350px',
      borderRadius: '20px',
