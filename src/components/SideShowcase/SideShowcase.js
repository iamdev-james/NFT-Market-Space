...
function SideShowcase () {
  return (
    <main className='dark:bg-darkMode max-w-body overflow-x-hidden flex flex-col lg:flex-row justify-start items-center pt-24 px-6 md:px-20 lg:px-10 xl:px-20'>
      <div className='flex-1 order-1 h-full flex flex-col justify-around items-start pr-0 md:pr-32 lg:pr-6 xl:pr-48'>
        <div className='mb-8'>
          ...
          <p style={{
            lineHeight: '100%',
            letterSpacing: '0.2px'
          }} className='text-4xl md:text-7xl xl:text-9xl font-bold dark:text-white'>Sapien ipsum scelerisque convallis fusce</p>
        </div>
